    ...
    return (
      <>
        <style jsx global>
          {`
      body {
        background-image: url("https://img.freepik.com/free-vector/gradient-galaxy-background-with-colorful-planets_23-2148999259.jpg");
        background-size: cover;
       }
   `}
        </style>
        <Card background={"#D7C4EA "}>
          <CardHeader>
        ...
        <Modal isOpen={isShowNftOpen} onClose={onShowNftClose}>
          <ModalOverlay />
          <ModalContent>
            <ModalHeader>Your minted Baby Galactic Travelers!:</ModalHeader>
            <ModalCloseButton />
            <ModalBody>
